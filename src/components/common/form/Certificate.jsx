...
const Certificate = ({ formData, treeCount, region, co2Savings, projectsData, onClose }) => {
  ...
  return (
    <div className="certificate-modal-overlay" onClick={handleOverlayClick}>
      <div className="certificate-figma-window" onClick={(e) => e.stopPropagation()}>
        
        <div className="certificate-top-bar">
          <div className="top-bar-left-indicator fonts-header">
            <span className="live-dot"></span> ROUTING ECOSYSTEM GUARDIANCE 
          </div>
          <div className="certificate-actions-row">
            <button onClick={() => window.print()} className="cert-action-btn print-btn fonts-body">
              Print / Save PDF 
            </button>
            <button onClick={onClose} className="action-close-link fonts-body">
              Return to Surface ↗
            </button>
          </div>
        </div>
            ...
            <div className="certificate-frame">
              <div className="certificate-inner-border">
                ...
                <p className="certificate-declaration fonts-body">
                  has authorized a vital ecological deployment in the <strong className="cert-highlight manifesto-highlight">{projectsData[region].title}</strong>. 
                  By securing <strong className="cert-highlight manifesto-highlight">{treeCount} units</strong> of native flora, this commitment commands an annual offset of 
                  <strong className="cert-highlight manifesto-highlight"> -{co2Savings}kg CO₂</strong>, establishing a permanent legacy for the planet's biome.
                </p>
                ...
                <div className="certificate-footer">
                  ...
                  <div className="cert-footer-block cert-signature-block">
                    ...
                    <span className="cert-signature fonts-body">Tree Foundation</span>
                  </div>

                  <div className="cert-footer-block">
                    <span className="cert-label fonts-header">Certificate ID</span>
