      ...
      <div className="features-content">
        <div className="f-text-block">
          ...
          <p className="features-body">
            Every tree nurtured today strengthens our shared future. Together,
            we transform small actions into lasting impact for people and the
            planet.
          </p>
        </div>
      </div>
      ...
      <div className="features-container">
        <div className="card">
          <svg
            ...
            <g clipPath="url(#clip0_641_4260)">
              {/* Orijinal fill="black" yerine "currentColor" yazarak kartın mavisini alması sağlandı */}
              <path
          ...
          <div className="card__content">
            <h2 className="card__title features-header">
        ...
        <div className="card">
          <div className="card__content">
            ...
            <p className="card__description features-body">
              Every tree planted helps reduce your carbon footprint and
        ...
        <div className="card">
          <div className="card__content">
            ...
            <p className="card__description features-body">
              The steps we take today build a sustainable, intelligent green
